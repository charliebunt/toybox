...
// Showcase vs Store
if (STORE_STATUS == '0') {
  define('TEXT_GREETING_GUEST', ' <span class="greetUser"></span> Would you like to <a href="%s">register or log yourself in ?</a>');
} else {
...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('HEADING_TITLE', 'Welcome to the Toybox Store where you can buy tickets and merchandise online.');
